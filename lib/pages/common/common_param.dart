...
const String VERSION = "version"; //后台版本
const String DOWNLAOD_URL = "downLoadUrl"; //新的app下载地址

const String PHONE_NUMBER = "phoneNum"; //sp保存的手机 key

const int MAX_IAMGE_VIDEO = 12; //最大图片和视频数

final String IMAGE_VIDEO_URL =
    "${gnNetType == 0 ? URL.API_ADD_UPLOAD : URLIntranet.API_ADD_UPLOAD}"; //用于拼接已有的视频或图片的网络地址
...
const List<String> lsCalendar=["一","二","三","四","五","六","日"];